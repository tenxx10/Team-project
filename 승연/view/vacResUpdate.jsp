					...
					<form name="resForm" action="vacResUpdateProcess.jsp" method="post">
						<table class="mx-auto">
							...
							<tr>
								...
								<td colspan="3" class="td_title"><br>(대상질병은 취소 후 다시
									예약바랍니다.)<br>
								<br></td>
							</tr>
							<tr>
								...
								<td>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="reserve_gen" id="male" value="male"
											<%= reserveGen.equals("male") ? "checked" : "" %> required>
										<label class="form-check-label" for="male">남</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio"
											name="reserve_gen" id="female" value="female"
											<%= reserveGen.equals("female") ? "checked" : "" %> required>
							...
							<tr>
								...
								<td><input type="number" class="form-control"
									name="reserve_age" id="reserve_age_input"
									value="<%= reserveAge %>" placeholder="숫자만 입력 예시) 30"
									oninput="validateAge()" required> <span id="ageError"
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									...
									value="<%= reservePhone %>" placeholder="연락처를 입력해주세요"></td>
							</tr>
							<tr>
								<td><label for="reserve_email">회원 이메일 :</label></td>
								<td><input type="text" class="form-control"
									name="reserve_email" id="reserve_email"
									value="<%= reserveEmail %>" placeholder="이메일을 입력해주세요"></td>
							</tr>
							<tr>
								<td><label for="reserve_disease">접종대상 질병 :</label></td>
								<td><input type="text" class="form-control"
									name="reserve_disease" id="reserve_disease"
									value="<%= reserveDisease %>" readonly></td>
							</tr>
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									...
									value="<%= reserveItem %>" placeholder="원하시는 제품이 없을 경우 공란 "></td>
							...
							<tr>
								...
								<td><input type="date" class="form-control"
									...
									value="<%= reserveDate %>" required oninput="validateDate()"></td>
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									...
									value="<%= reserveLocal %>" placeholder="없다면 공란"></td>
							</tr>
						...
						<!-- 예약 취소 버튼 -->
						<a href="vacResCancelProcess.jsp?reserve_no=<%= reserveNo %>"
