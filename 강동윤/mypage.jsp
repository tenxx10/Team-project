      ...
      <div class="row">
        ...
        <center>
                    ...
                    %>
							...
							<!-- 로그아웃 모달 불러와서 사용 -->
							<jsp:include page="logout_modal.jsp" />
							    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#changePasswordModal">비밀번호 변경</button>
							    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#logoutModal">로그아웃</button>
							</tr>
