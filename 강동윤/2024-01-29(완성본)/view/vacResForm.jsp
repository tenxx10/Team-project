...
%>
					...
					<form name="resForm" action="vacResProcess.jsp" method="post">
						<table class="mx-auto">
							...
							<tr>
							    ...
							    <td>
							        <input type="radio" name="reserve_gen" id="male" value="male" <%= ("male".equals(userGen)) ? "checked" : "" %> onchange="hideGenderError()">남
							        <input type="radio" name="reserve_gen" id="female" value="female" <%= ("female".equals(userGen)) ? "checked" : "" %> onchange="hideGenderError()">여
							        <span id="genderError" style="color: red;">예약자 성별을 선택해 주세요.</span>
							    </td>
							</tr>
							...
							<tr>
								...
								<span id="diseaseError" style="color: red;">대상 질병을 선택해 주세요.</span>
							    </td>
							</tr>
				...
				<br> <br> <br>
				<p>
				<!-- 이전 페이지 URL을 로그인 페이지에 전달 -->
					<a href="login.jsp?returnUrl=vacResForm.jsp">
					   로그인 후 사용가능한 페이지입니다.
					</a>
				</p>
				<%
