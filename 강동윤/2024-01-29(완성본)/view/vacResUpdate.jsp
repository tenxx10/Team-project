...
<!--  예약 수정 폼 -->
        ...
        <input type="hidden" name="reserve_no" value="<%= reserveNo %>">
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="reserve_item" id="reserve_item" value="<%= reserveItem %>" placeholder="원하시는 제품이 없을 경우 공란 "></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="reserve_local" id="reserve_local" value="<%= reserveLocal %>" placeholder="없다면 공란"></td>
                    </tr>
                	...
                	<!-- 예약 취소 버튼 -->
					<a href="vacResCancelProcess.jsp?reserve_no=<%= reserveNo %>" class='btn btn-danger'>예약 취소</a>
			</form>
