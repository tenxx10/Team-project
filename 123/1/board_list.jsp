...
<%@ page import="board.model.PageInfo" %>
            ...
            <main class="col-lg-10 col-md-7 ms-md-auto px-4">
                ...
                <section id="listForm">
                    ...
                    <aside id="writeLink" style="float: right; margin-top: 20px;">
                        <a href="boardWriteForm.bo" style="color: black;">공지사항 글쓰기</a>
                        <a href="boardList.bo?page=1"></a>
                    </aside>
                    <table>
                        <%
                        ...
                        <tr>
                            ...
                            <td>
                                <% if(articleList.get(i).getBOARD_RE_LEV()!=0){ %>
                                    ...
                                    <% } %> 
                                <% } else { %>  <% } %>
                                <a href="boardDetail.bo?board_num=<%= articleList.get(i).getBOARD_NUM() %>&page=<%= nowPage %>" style="color: black;">
