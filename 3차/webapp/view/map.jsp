			...
			<main class="col-lg-10 col-md-7 ms-md-auto px-4">
				<div class="text-center mt-5">
					...
					<div class="custom-box">
						...
						<h4 class="head">2. 보건소 정보 표</h4>
						<p> 아래에 보건소의 이름과 주소, 전화번호가 나열된 표가 있습니다. 보건소 방문시 참고하시길 바랍니다.</p>

						<h4 class="head">3. 주의사항</h4>
						<ul>
							<li>보건소 정보는 실제 서비스 기관에서 제공하는 정확한 정보를 기반으로 합니다.</li>
							<li>지도에서 표시된 위치는 참고용이며, 실제 보건소 방문 시에는 정확한 주소 및 연락처를 확인해주세요.</li>
						</ul>
