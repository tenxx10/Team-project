...
public class BoardDAO2 {
	...
	//글 목록 보기
	public ArrayList<BoardBean2> selectArticleList(int page,int limit){
	...
	//글 내용 보기
	public BoardBean2 selectArticle(int board_num){
	...
	//글 등록
	public int insertArticle(BoardBean2 article){
	...
	//글 답변
	public int insertReplyArticle(BoardBean2 article){
	...
	//글 수정
	public int updateArticle(BoardBean2 article){
