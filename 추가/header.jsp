        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="font-weight:bold;">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/team/boardList.boa">Board</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/team/boardList.bo">Notice</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/team/view/mypage.jsp">Mypage</a>
                    </li>
                    <%-- 세션에 user_id가 없으면 링크를 보여줌 --%>
    				<li class="nav-item">
    				<% if (session.getAttribute("user_id") == null) { %>
                    <a class="nav-link" href="/team/view/login.jsp">Login</a>
    				<% } %></li>
    				
                    <li class="nav-item">
				    <% if (session.getAttribute("user_id") == null) { %>
				        <a class="nav-link" href="/team/view/join.jsp">Join</a>
				    <% } %></li>
