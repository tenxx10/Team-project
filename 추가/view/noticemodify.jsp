						...
						<table>
							<tr>
								...
								<td class="td_right"><input type="text" name="BOARD_NAME"
									id="BOARD_NAME"
									value="<%= article != null ? article.getBOARD_NAME() : "" %>" /></td>
							</tr>
							<tr>
								<td class="td_left"><label for="BOARD_PASS">비밀번호</label></td>
								<td class="td_right"><input name="BOARD_PASS"
									type="password" id="BOARD_PASS" /></td>
							</tr>
							<tr>
								<td class="td_left"><label for="BOARD_SUBJECT">제목</label></td>
								<td class="td_right"><input id="BOARD_SUBJECT"
									name="BOARD_SUBJECT" type="text"
									value="<%= article != null ? article.getBOARD_SUBJECT() : "" %>" /></td>
							</tr>
							<tr>
								<td class="td_left"><label for="BOARD_CONTENT">내용</label></td>
								<td><textarea name="BOARD_CONTENT" id="BOARD_CONTENT"
										cols="40" rows="15"><%= article != null ? article.getBOARD_CONTENT() : "" %></textarea></td>
							</tr>
						</table>
