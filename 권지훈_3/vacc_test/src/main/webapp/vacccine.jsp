...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="index.html">접종 친구</a>
        <button
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <h1 class="fw-bolder">예방접종 정보</h1>
    
   	<h3 class="fw-bolder"><br><br><br>1. 예방접종 대상 감염병 기준 목록 조회</h3>
    <button onclick="getVaccinationDiseases()">조회하기</button>
    <div id="vaccinationDiseases"></div>
    <br><br><br>
    <h3 class="fw-bolder">2. 예방접종 대상 감염병 상세 정보 조회</h3>
    <label for="vaccinationCode">접종코드:</label>
    <input type="text" id="vaccinationCode" placeholder="예: V001">
    <button onclick="getVaccinationDetails()">조회하기</button>
