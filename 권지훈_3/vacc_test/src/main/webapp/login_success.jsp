...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
        ...
        <p>환영합니다, <%= session.getAttribute("user_name") %>님!</p>
        
        <p><a href="mypage.jsp" class="btn btn-primary">마이페이지</a></p>
        
        <!-- 로그아웃 모달 불러오기 -->
        <jsp:include page="logout_modal.jsp" />
        <p><a href="logout.jsp"class="btn btn-success" data-bs-toggle="modal" data-bs-target="#logoutModal">로그아웃</a></p>
        </center>
