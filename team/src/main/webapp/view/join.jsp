				...
				<div class="container my-5">
					...
					<div>
						<form action="register.jsp" method="post">
							...
							<button type="submit" class="btn btn-primary" onclick="combinePhoneInputs()">회원가입</button>
...
<!-- JavaScript 코드 부분 -->
<script>
   function combinePhoneInputs() {
       // 각각의 input 값들을 가져옴
       var phone1 = document.getElementById('user_phone1').value;
       var phone2 = document.getElementById('user_phone2').value;
       var phone3 = document.getElementById('user_phone3').value;
       // 하나의 문자열로 합침 (예: 010-1234-5678)
       var combinedPhone = phone1 + '-' + phone2 + '-' + phone3;
       // 합친 값을 새로운 hidden input에 할당
       var hiddenInput = document.createElement('input');
       hiddenInput.type = 'hidden';
       hiddenInput.name = 'user_phone';
